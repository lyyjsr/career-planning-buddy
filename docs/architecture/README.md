...
| [cron-and-workers.md](./cron-and-workers.md) | 单 Worker 执行、超时回收和定时任务 |
...
架构事实：FastAPI 单体、React SPA、PostgreSQL + pgvector、单核心 Agent、三类 Provider、MVP 单 Worker，无 ClawAgent 依赖。
