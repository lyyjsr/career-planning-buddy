...
| 2 | user_profiles | 用户画像（goal_type 等） | [user_profiles.md](./user_profiles.md) |
| 3 | plans | 计划（含 version 乐观锁） | [plans.md](./plans.md) |
| 4 | tasks | 任务（含 state 机字段） | [tasks.md](./tasks.md) |
| 5 | reviews | 复盘（mood / blockers） | [reviews.md](./reviews.md) |
| 6 | memories | 长期记忆（5 类 + embedding） | [memories.md](./memories.md) |
...
| 10 | agent_runs + agent_steps + tool_calls | Trace 三表 | [trace-tables.md](./trace-tables.md) |
